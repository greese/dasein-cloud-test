    ...
    public void productContent() throws CloudException, InternalException {
        ...
        if( services != null ) {
            ...
            if( support != null ) {
                ...
                assertTrue("Product root volume size must be greater than 0", prd.getRootVolumeSize().intValue() > 0); // GCE root volume size is user configurable. always 0 until root volume attached.
