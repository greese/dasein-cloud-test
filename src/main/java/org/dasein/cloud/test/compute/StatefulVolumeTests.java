...
public class StatefulVolumeTests {
    ...
    @Before
    public void before() throws InternalException, CloudException {
        ...
        if( services != null ) {
            ...
            if( support != null ) {
                ...
                if( productId != null ) {
                    ...
                    options = VolumeCreateOptions.getInstance(productId, size, "dsnvolprv" + (System.currentTimeMillis()%10000), "Volume Provisioning Test", 0).inDataCenter(testDataCenterId);
                }
                if( options == null ) {
                    options = VolumeCreateOptions.getInstance(support.getCapabilities().getMinimumVolumeSize(), "dsnvolprv" + (System.currentTimeMillis()%10000), "Volume Provisioning Test").inDataCenter(testDataCenterId);
                }
            ...
            if( support != null ) {
                ...
                if( testVLANId != null ) {
                    ...
                    if( productId != null ) {
                        ...
                        options = VolumeCreateOptions.getNetworkInstance(productId, testVLANId, size, "dsnnfsvol" + (System.currentTimeMillis()%10000), "Dasein NFS volume test").inDataCenter(testDataCenterId);
                    }
                    if( options == null ) {
                        options = VolumeCreateOptions.getNetworkInstance(testVLANId, support.getCapabilities().getMinimumVolumeSize(), "dsnvolprv" + (System.currentTimeMillis()%10000), "Volume Provisioning Test").inDataCenter(testDataCenterId);
                    }
        ...
        if( services != null ) {
            ...
            if( support != null ) {
                ...
                if( productId != null ) {
                    ...
                    options = VolumeCreateOptions.getInstanceForSnapshot(productId, testSnapshotId, size, "dsnvolprv" + (System.currentTimeMillis()%10000), "Volume Provisioning Test", 0).inDataCenter(testDataCenterId);
                }
                if( options == null ) {
                    options = VolumeCreateOptions.getInstanceForSnapshot(testSnapshotId, support.getCapabilities().getMinimumVolumeSize(), "dsnvolprv" + (System.currentTimeMillis()%10000), "Volume Provisioning Test").inDataCenter(testDataCenterId);
                }
